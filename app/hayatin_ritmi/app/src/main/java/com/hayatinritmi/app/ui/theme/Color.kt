...
val CardSurface      = Surface0

// ── CAM EFEKTİ ─────────────────────────────────────
val GlassWhite       = Color(0x0DFFFFFF)
val GlassMedium      = Color(0x14FFFFFF)
val GlassBright      = Color(0x1FFFFFFF)
...
val RoseSubtle       = Color(0x1AE11D48)

// ── TIBBİ DURUM RENKLERİ ──────────────────────────
val Emerald500       = Color(0xFF10B981)
val Emerald400       = Color(0xFF34D399)
val EmeraldSubtle    = Color(0x1A10B981)

val NeonBlue         = Color(0xFF3B82F6)
val BlueLight        = Color(0xFF60A5FA)
val BlueSubtle       = Color(0x1A3B82F6)

val AmberWarning     = Color(0xFFF59E0B)
val AmberSubtle      = Color(0x1AF59E0B)

val NeonRed          = Color(0xFFE11D48)
val AlarmRed         = Color(0xFFFF0000)
val ErrorRed         = Color(0xFFEF4444)
val RedSubtle        = Color(0x1AEF4444)

val CyanAccent       = Color(0xFF06B6D4)
val CyanSubtle       = Color(0x1A06B6D4)
